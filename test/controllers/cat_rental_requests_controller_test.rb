...
class CatRentalRequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat_rental_request" do
    assert_difference("CatRentalRequest.count") do
      post cat_rental_requests_url, params: { cat_rental_request: { cat_id: @cat_rental_request.cat_id, end_date: @cat_rental_request.end_date, start_date: @cat_rental_request.start_date, status: @cat_rental_request.status } }
    end
  ...
  test "should update cat_rental_request" do
    patch cat_rental_request_url(@cat_rental_request), params: { cat_rental_request: { cat_id: @cat_rental_request.cat_id, end_date: @cat_rental_request.end_date, start_date: @cat_rental_request.start_date, status: @cat_rental_request.status } }
